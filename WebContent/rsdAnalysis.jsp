									...
									<fieldset class="zs zs_rsd_fieldset">
										...
										<table>
											<tr>
												...
												<td><select name="tables" id="tables"></select></td>
												...
												<select name="maxBatchNo" id="maxBatchNo" class="zs_ser"></select></td>
											...
											<tr>
												...
												<select name="end" id="end" class="zs_ser"></select >
												</td>
								
												<td class="zs_name"><span>项目:</span></td>
												<td><select name="proj" id="zs_proj"></select></td>
											</tr>
										</table>
									</fieldset>
									<div class="zs_cal">
										<div class="zs_sr">
											<span>中间体:</span>
											<span class="zs_svalue">value</span>
										</div>
										<div class="zs_sr">
											<span>RSD值:</span>
											<span class="zs_svalue">value</span>
